...
function splitMe(str) {
  let splitted = str.split(" "); // divido la stringa al livello dello spazio vuoto in modo da separare tutte le parole
  return splitted
}
console.log(splitMe('I love pizza'));
...
console.log(deleteOne('Domenica', false));
...
function onlyLetters(str) {
 str = str.replace (/ [0-9] /, " "); // rimpiazzo i numeri presenti nella stringa con un spazio vuoto
  return str
}
...
let ciao = obj
obj = {
parametro1: banana  // ci ho provato
}
obj.push(str)
} console.log(deleteProp(ciao, comeStai))*/
